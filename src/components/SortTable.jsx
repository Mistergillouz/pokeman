...
class SortTable extends React.Component {
  constructor (props) {
    ...
    let sortIndex = -1; let ascending = false
  ...
  onSort (index) {
    ...
    let ascending = this.state.ascending; let sortIndex = this.state.sortIndex
    if (sortIndex === index) {
      ascending = !ascending
    } else {
      sortIndex = index
  ...
  _sort (sortIndex, ascending) {
    this.getIndices().sort((a, b) => {
      let v0 = this.props.datas[a][sortIndex] || 0; let v1 = this.props.datas[b][sortIndex] || 0
